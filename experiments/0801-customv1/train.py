...
def main():
    # 1. 路径
    model_path = "/workspace/yolov11bee/experiments/0801-customv1/01freeze3/weights/best.pt"
    ...
    train_args = dict(
        ...
        project="/workspace/yolov11bee/experiments/0801-customv1",
        name="01freeze",           # 日志目录 runs/01train
        ...
        # ---- 数据增强 ----
        hsv_h=0.01,               # 调整图像的色调 0.015
        hsv_s=0.35,               # 改变图像饱和度 0.7
        hsv_v=0.2,                # 改变图像的亮度 0.4
        ...
        flipud=0.5,           #*  # 以指定的概率将图像翻转过来，在不影响物体特征的情况下增加数据的可变性。
